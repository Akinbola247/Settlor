    ...
    <>
      ...
      <section className="relative overflow-hidden gradient-hero text-white">
        ...
        <ScrollReveal immediate className="relative mx-auto max-w-6xl px-4 pb-24 pt-20 sm:px-6 lg:pb-32 lg:pt-28">
          <p className="text-sm font-semibold uppercase tracking-widest text-orange-400">{HERO.eyebrow}</p>
          <h1 className="mt-4 max-w-3xl font-serif text-4xl font-bold leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl">
            {HERO.title}
          </h1>
        ...
        <div className="mx-auto grid max-w-6xl gap-8 px-4 sm:grid-cols-3 sm:px-6">
          {STATS.map((s, i) => (
            <ScrollReveal key={s.label} delay={i * 80} className="text-center sm:text-left">
              <p className="font-serif text-4xl font-bold text-[var(--color-brand)]">{s.value}</p>
      ...
      <section className="section-anchor py-20 lg:py-24">
        <ScrollReveal className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              <p className="text-sm font-bold uppercase tracking-widest text-orange-600">Why iPayX</p>
              ...
              <p className="mt-4 text-[var(--color-muted)] leading-relaxed">
                ...
                teams. iPayX sits in the middle: professional invoices for you, guided payment for your
                clients, and one Arc balance when money arrives.
              </p>
            </div>
            <div className="card p-8 lg:p-10">
              <ul className="space-y-4 text-sm">
                {[
                  ...
                  "CCTP routes USDC to your Arc programmable wallet",
      ...
      <section id="product" className="section-anchor border-t border-[var(--color-border)] bg-white py-20 lg:py-28">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <ScrollReveal className="max-w-2xl">
            <p className="text-sm font-bold uppercase tracking-widest text-orange-600">Product</p>
            <h2 className="mt-3 font-serif text-3xl font-bold lg:text-4xl">Everything in one workspace</h2>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <ScrollReveal className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-xl">
              ...
              <h2 className="mt-3 font-serif text-3xl font-bold">Four steps from sign-in to paid</h2>
            </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {HOW_IT_WORKS_STEPS.map((s, i) => (
              ...
              <div className="card p-6">
                <span className="text-xs font-bold text-orange-600">{s.step}</span>
      ...
      <section id="for-payers" className="section-anchor border-t border-[var(--color-border)] bg-white py-20 lg:py-28">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <ScrollReveal>
          <h2 className="font-serif text-3xl font-bold text-center lg:text-4xl">Built for both sides of the invoice</h2>
          </ScrollReveal>
      ...
      <section id="getting-started" className="section-anchor py-20 lg:py-28">
        <ScrollReveal className="mx-auto max-w-6xl px-4 sm:px-6">
          <p className="text-sm font-bold uppercase tracking-widest text-orange-600">Getting started</p>
          <h2 className="mt-3 font-serif text-3xl font-bold">Never get lost in the app</h2>
          ...
          <div className="mt-10 overflow-x-auto">
            <div className="flex min-w-[640px] gap-4">
              {[
                ...
                { label: "Deposit", desc: "Other chain or Arc receive" },
          ...
          <p className="mt-8 text-center">
            <Link href="/help" className="font-semibold text-orange-600 hover:underline">
      ...
      <section className="py-20 lg:py-24">
        <ScrollReveal className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="card grid gap-8 p-8 lg:grid-cols-2 lg:p-12">
            <div>
              <h2 className="font-serif text-2xl font-bold">Security & trust</h2>
      ...
      <section id="faq" className="section-anchor border-t border-[var(--color-border)] bg-white py-20 lg:py-28">
        <ScrollReveal className="mx-auto max-w-3xl px-4 sm:px-6">
          <h2 className="text-center font-serif text-3xl font-bold">Common questions</h2>
          <div className="mt-10">
            <FaqAccordion items={FAQ} />
          </div>
          <p className="mt-8 text-center text-sm text-[var(--color-muted)]">
            More answers on our <Link href="/help" className="font-semibold text-orange-600 hover:underline">Help</Link> page.
          </p>
        </ScrollReveal>
      </section>
      ...
      <section className="gradient-hero py-20 text-center text-white lg:py-28">
        <ScrollReveal className="mx-auto max-w-2xl px-4 sm:px-6">
          <h2 className="font-serif text-3xl font-bold lg:text-4xl">Your next invoice is one sign-in away</h2>
